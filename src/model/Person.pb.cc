...
void protobuf_AddDesc_Person_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\014Person.proto\022\005model\"\324\001\n\006Person\022\014\n\004name"
    "\030\001 \002(\t\022\n\n\002id\030\002 \002(\005\022\r\n\005email\030\003 \001(\t\022(\n\005pho"
    "ne\030\004 \003(\0132\031.model.Person.PhoneNumber\032J\n\013P"
    "honeNumber\022\016\n\006number\030\001 \002(\t\022+\n\004type\030\002 \001(\016"
    "2\027.model.Person.PhoneType:\004HOME\"+\n\tPhone"
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::model::Person_PhoneType_IsValid(value)) {
            set_type(static_cast< ::model::Person_PhoneType >(value));
          } else {
