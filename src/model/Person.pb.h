...
class Person_PhoneNumber : public ::google::protobuf::Message {
 public:
  ...
  // optional .model.Person.PhoneType type = 2 [default = HOME];
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 2;
  inline ::model::Person_PhoneType type() const;
  inline void set_type(::model::Person_PhoneType value);
...
class Person : public ::google::protobuf::Message {
 public:
  ...
  // repeated .model.Person.PhoneNumber phone = 4;
  inline int phone_size() const;
  inline void clear_phone();
  static const int kPhoneFieldNumber = 4;
  inline const ::model::Person_PhoneNumber& phone(int index) const;
  inline ::model::Person_PhoneNumber* mutable_phone(int index);
  inline ::model::Person_PhoneNumber* add_phone();
  inline const ::google::protobuf::RepeatedPtrField< ::model::Person_PhoneNumber >&
      phone() const;
  inline ::google::protobuf::RepeatedPtrField< ::model::Person_PhoneNumber >*
      mutable_phone();
 ...
 private:
  ...
  ::std::string* name_;
  ::std::string* email_;
  ::google::protobuf::RepeatedPtrField< ::model::Person_PhoneNumber > phone_;
...
inline ::model::Person_PhoneType Person_PhoneNumber::type() const {
  return static_cast< ::model::Person_PhoneType >(type_);
}
inline void Person_PhoneNumber::set_type(::model::Person_PhoneType value) {
  assert(::model::Person_PhoneType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline const ::model::Person_PhoneNumber& Person::phone(int index) const {
  return phone_.Get(index);
}
inline ::model::Person_PhoneNumber* Person::mutable_phone(int index) {
  return phone_.Mutable(index);
}
inline ::model::Person_PhoneNumber* Person::add_phone() {
  return phone_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::model::Person_PhoneNumber >&
Person::phone() const {
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::model::Person_PhoneType>() {
  return ::model::Person_PhoneType_descriptor();
}
