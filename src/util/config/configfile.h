...
//=
// util::ConfigFile is the public interface for the config/ini file reader.
//=
class ConfigFile{

	// Bridge component
	//
	util::config::ConfigImpl *d_implementation;
...
public:
	...
	//=
	// Default constructor
	// Use to obtain an instance of the util::ConfigFile component
	// 
	// <b>Example:</b>
	// <code>
	// util::ConfigFile myconfig;
	// 
	// //OR
	// 
	// util::ConfigFile *myconfig = new util::ConfigFile();
	// </code>
	//= 
	ConfigFile();
	...
	// <b>Example:</b>
	// 
	// <code>const char *version = ConfigFile::version();</code>
	//=
	...
	// a new file, or use another ConfigFile object instance.
	//=
	bool load();
